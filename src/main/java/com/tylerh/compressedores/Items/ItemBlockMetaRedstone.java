...
public class ItemBlockMetaRedstone extends ItemBlock
{
    public ItemBlockMetaRedstone(Block block)
    {
        super(block);
    ...
    {
        list.add(ModInfo.matCosts[stack.getMetadata()] + " Blocks of Redstone");
    }
}
