...
public class ItemBlockMetaEmerald extends ItemBlock
{
    public ItemBlockMetaEmerald(Block block)
    {
        super(block);
    ...
    {
        list.add(ModInfo.matCosts[stack.getMetadata()] + " Blocks of Emerald");
    }
}
