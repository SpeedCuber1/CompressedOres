...
public class CompOreAdvancementGenerator implements DataProvider
{
    ...
    private void generateAdvancements(Consumer<Advancement> consumer)
    {
        ...
        var craftCompressed = Advancement.Builder.advancement()
                ...
                .addCriterion(EnumCriterionCompOres.END_STONE.getString(),InventoryChangeTrigger.TriggerInstance.hasItems(BlockList.blockEndStoneCompressed.get()))
        ...
        var craftDouble = Advancement.Builder.advancement()
                ...
                .addCriterion(EnumCriterionCompOres.END_STONE.getString(),InventoryChangeTrigger.TriggerInstance.hasItems(BlockList.blockEndStoneDouble.get()))
        ...
        var craftTriple = Advancement.Builder.advancement()
                ...
                .addCriterion(EnumCriterionCompOres.END_STONE.getString(),InventoryChangeTrigger.TriggerInstance.hasItems(BlockList.blockEndStoneTriple.get()))
        ...
        var craftQuadruple = Advancement.Builder.advancement()
                ...
                .addCriterion(EnumCriterionCompOres.END_STONE.getString(),InventoryChangeTrigger.TriggerInstance.hasItems(BlockList.blockEndStoneQuadruple.get()))
        ...
        var craftQuintuple = Advancement.Builder.advancement()
                ...
                .addCriterion(EnumCriterionCompOres.END_STONE.getString(),InventoryChangeTrigger.TriggerInstance.hasItems(BlockList.blockEndStoneQuintuple.get()))
        ...
        var craftSextuple = Advancement.Builder.advancement()
                ...
                .addCriterion(EnumCriterionCompOres.END_STONE.getString(),InventoryChangeTrigger.TriggerInstance.hasItems(BlockList.blockEndStoneSextuple.get()))
        ...
        var craftSeptuple = Advancement.Builder.advancement()
                ...
                .addCriterion(EnumCriterionCompOres.END_STONE.getString(),InventoryChangeTrigger.TriggerInstance.hasItems(BlockList.blockEndStoneSeptuple.get()))
        ...
        var craftOctuple = Advancement.Builder.advancement()
                ...
                .addCriterion(EnumCriterionCompOres.END_STONE.getString(),InventoryChangeTrigger.TriggerInstance.hasItems(BlockList.blockEndStoneOctuple.get()))
