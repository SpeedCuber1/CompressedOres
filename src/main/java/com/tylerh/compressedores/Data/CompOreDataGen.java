...
public class CompOreDataGen
{
    ...
    public static void gatherData(GatherDataEvent event)
    {
        ...
        generator.addProvider(true,new CompOreBlockTag(generator,existingFileHelper));
        generator.addProvider(true,new CompOreBlockstateProvider(generator,existingFileHelper));
    }
}
